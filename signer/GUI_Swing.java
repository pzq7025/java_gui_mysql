...
public class GUI_Swing implements ActionListener {
    ...
    public void actionPerformed (ActionEvent e){
        ...
        if(e.getSource() == Change_Pass){
            JOptionPane.showMessageDialog(null, "Will in Change_Password Interface");
            cp = new change_password();
        } else if (e.getSource() == Save_Money) {
            JOptionPane.showMessageDialog(null, "Will enter the Save_Money Interface");
            sm = new save_money();
        } else if(e.getSource() == WithDraw_Money){
